    ...
    <>
      <div className="flex flex-col h-full overflow-y-auto scrollbar-hide" style={{ background: '#080F07' }}>
        ...
        <div className="px-6 mt-8 mb-2">
          <div className="h-px w-full" style={{ background: 'linear-gradient(to right, transparent, rgba(212,84,26,0.3), transparent)' }} />
        </div>
...
function Badge({ children, amber }: { children: React.ReactNode; amber?: boolean }) {
  return (
    <span
      ...
      style={
        amber
          ? { color: '#E87820', background: 'rgba(232,120,32,0.1)', border: '1px solid rgba(232,120,32,0.28)' }
